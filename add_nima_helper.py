...
import kickstarter.transformers.nima
from kickstarter.data_loader import get_pickles

def _download_nima_pickle():
    df = get_pickles('with_NIMA.pickle')
    kickstarter.transformers.nima.add_nima(df, jsonFile='NIMA predictions/predictions_imgs_all_technical.json', columnName='nima_tech')
